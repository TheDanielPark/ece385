...
# Create a new driver
create_driver altera_nios2_gen2_ucosiii_driver

# Associate it with some hardware known as "altera_nios2_gen2"
set_sw_property hw_class_name altera_nios2_gen2
...
# C/C++ source files
add_sw_property c_source HAL/src/altera_nios2_gen2_irq.c

# Include files
add_sw_property include_source HAL/inc/altera_nios2_gen2_irq.h
